...
public class EmailNotifier {
    private static final String FROM = "enverest@ya.ru";
    private static final String TO = "enverest@i.ua";

    @SuppressWarnings("SpringJavaAutowiringInspection")
    @Autowired JavaMailSender mailSender;

    public void newQuoteLink(String termName, String itemNumber, String qoute, Integer linkId) {
